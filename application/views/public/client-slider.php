        ...
        jQuery(document).ready(function ($) {
            ...
            function ScaleSlider() {
                ...
                if (parentWidth)
                    ...
                    jssor_slider1.$ScaleWidth(Math.min(parentWidth, 459));
...
<?php foreach($clients as $client): ?>
            <div>
                ...
                <a u=image href="#" class="showclient" data-toggle="modal" data-target="#clients" title="<?php echo $client['name']; ?>"><img src="images/clients/<?php echo $client['display_img']; ?>" /></a>
                <input type="hidden" class="contentimg" value="<?php echo $client['content_img']; ?>">
                <input type="hidden" class="contentvid" value="<?php echo $client['content_vid']; ?>">
...
<!--
            <div>
                ...
                <a u=image href="#" data-toggle="modal"  data-target="#coke"><img src="images/clients/coke.png" /></a>

            </div>

            <div>

                <a u=image href="#" data-toggle="modal"  data-target="#sandstorm"><img src="images/clients/sandstorm.png" /></a>
